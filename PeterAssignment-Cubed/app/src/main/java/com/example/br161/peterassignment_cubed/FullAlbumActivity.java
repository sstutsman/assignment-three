...
public class FullAlbumActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle extras = getIntent().getExtras();  //Used to easily grab INT

        imgAlbumCover_full  = (ImageView) findViewById(R.id.draw_albumcover_full);
        imgAlbumCover_full.setImageResource(extras.getInt("albumArt"));
        ...
        year_full.setText(extras.getInt("year"));
        ...
        trackAmt_full.setText(extras.getInt("trackCt"));
